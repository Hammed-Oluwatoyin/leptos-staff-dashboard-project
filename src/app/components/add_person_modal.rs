...
pub fn AddPersonModal(
    ...
    let (person_title, set_person_title) = signal(String::new());
    let (person_level, set_person_level) = signal(String::new());
    let (compensation, set_compensation) = signal(String::new());
